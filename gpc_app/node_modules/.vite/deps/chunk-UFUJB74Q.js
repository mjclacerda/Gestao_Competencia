...
var plugin_colors = {
  ...
  beforeLayout(chart, _args, options) {
    ...
    const { options: { elements: elements2 }, data: { datasets } } = chart.config;
    if (!options.forceOverride && (containsColorsDefinitions(datasets) || elements2 && containsColorsDefinitions(elements2))) {
      return;
    }
 ...
 * Released under the MIT License
 */
//# sourceMappingURL=chunk-UFUJB74Q.js.map
